...
import trendingIcon from "../../../assets/solution_pages/gig_economy/sections/product_stack/trending.svg";
...
const stackItems = [
  {
    ...
    description: "Run worker checks across document, face, bank, and phone signals.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Fetch and verify identity documents for faster worker activation.",
  },
  {
    icon: networkIcon,
    title: "Mobile Intelligence",
    description: "Assess number quality, reachability, activity, and fraud signals.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Validate payout accounts before releasing worker earnings.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Prevent proxy workers and duplicate identity submissions.",
  },
  {
    icon: trendingIcon,
    title: "Document Verification",
    description: "Verify licenses, permits, certificates, and onboarding documents.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="gig-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
