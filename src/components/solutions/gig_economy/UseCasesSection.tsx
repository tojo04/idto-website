...
const useCases = [
  { icon: rocketIcon, title: "10 Minute Gig Worker Onboarding" },
  { icon: repeatIcon, title: "Driver And Delivery Partner Verification" },
  { icon: trendingIcon, title: "Payout Account Validation" },
  { icon: callIcon, title: "Proxy Worker Prevention" },
  { icon: tickIcon, title: "Contactability Checks" },
  { icon: eyeIcon, title: "Document Backed Activation Workflows" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to verify gig workers end-to-end from first-time onboarding to safer activation.
          </p>
          <a
