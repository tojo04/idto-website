...
const stackItems = [
  {
    icon: docIcon,
    title: "CKYC 2.0",
    description: "Move existing users into compliant KYC flows.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Verify Aadhaar and user-consented documents.",
  },
  {
    icon: networkIcon,
    title: "Mobile Intelligence",
    description: "Analyze mobile activity, reachability, and risk signals.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Confirm withdrawal and beneficiary account ownership.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Add stronger checks for higher-risk actions.",
  },
  {
    icon: trendingIcon,
    title: "Risk & Alternate Data Signals",
    description: "Better understand user and transaction risk with extra signals.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="crypto-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
