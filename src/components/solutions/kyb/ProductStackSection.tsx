...
const stackItems = [
  {
    icon: docIcon,
    title: "CKYC 2.0",
    description: "Support standardized business and merchant checks with one workflow layer.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Fetch business and owner documents where available.",
  },
  {
    icon: networkIcon,
    title: "Business Verification",
    description: "Verify PAN, GSTIN, CIN, directors, UBOs, and business signals.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Validate merchant settlement and payout accounts.",
  },
  {
    icon: faceMatchIcon,
    title: "KYB Workflows",
    description: "Create configurable flows for documents, ownership, UBOs, and approvals.",
  },
  {
    icon: trendingIcon,
    title: "Workflow Dashboard",
    description: "Track merchant status, verification attempts, audit logs, and operations.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="kyb-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
      <div className="max-w-[886px] mx-auto flex flex-col gap-10 items-center">
        ...
        >
          <h2 className="font-heading text-[28px] md:text-[42px] leading-[1.3] text-white">
            idto stack for merchant onboarding
          </h2>
          <img
            src={linesAccent}
            alt=""
            className="hidden sm:block absolute left-1/2 top-[55px] w-[260px] md:w-[285px] -translate-x-[2%]"
            loading="lazy"
            decoding="async"
          />
        </motion.div>
