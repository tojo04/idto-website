...
const useCases = [
  { icon: rocketIcon, title: "Merchant Onboarding" },
  { icon: repeatIcon, title: "PAN + GSTIN API Workflows" },
  { icon: trendingIcon, title: "Seller And Vendor Verification" },
  { icon: callIcon, title: "Settlement Account Validation" },
  { icon: tickIcon, title: "Owner And Authorized Signatory Checks" },
  { icon: eyeIcon, title: "Compliance-Ready Audit Trails" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to ship fast identity and risk flows from merchant onboarding to safer collections.
          </p>
          <a
