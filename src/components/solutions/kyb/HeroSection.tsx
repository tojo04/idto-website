import heroVisual from "../../../assets/solution_pages/kyb/sections/hero/52ad46a3a478d1f13847a02bc58372f1ff006809.webp";
  ...
  return (
    <section className="solution-hero-section bg-white rounded-b-[40px] lg:rounded-b-[112px] px-5 lg:px-10 min-[1440px]:px-[111px] pt-8 lg:pt-[95px] pb-10 lg:pb-[95px] overflow-hidden">
      ...
      <div className="solution-hero-inner relative isolate mx-auto flex max-w-[1300px] flex-col lg:block lg:h-[408px]">
        ...
        >
          <h1 className="font-heading text-[20px] md:text-[42px] lg:w-[611px] lg:text-[42px] leading-[1.3] tracking-[0.6px] lg:tracking-[-0.84px] text-black">
            Merchant onboarding and{" "}
            <span className="text-primary">KYB workflows from one stack.</span>
          </h1>
        ...
        >
          <img
            src={heroVisual}
            alt="Merchant onboarding and KYB workflow"
        ...
        <div
          ...
          className="order-3 relative z-20 mt-6 flex flex-col gap-[18px] items-center lg:absolute lg:left-0 lg:top-[258px] lg:mt-0 lg:items-start"
        >
