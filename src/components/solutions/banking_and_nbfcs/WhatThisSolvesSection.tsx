...
import tickIcon from "../../../assets/solution_pages/banking_and_nbfcs/sections/what_this_solves/tick.svg";
import fragmentIcon from "../../../assets/solution_pages/banking_and_nbfcs/sections/what_this_solves/fregment.svg";
import fileIcon from "../../../assets/solution_pages/banking_and_nbfcs/sections/what_this_solves/file.svg";
import eyeIcon from "../../../assets/solution_pages/banking_and_nbfcs/sections/what_this_solves/eye.svg";

const problems = [
  {
    icon: tickIcon,
    title: "Heavy compliance workflows",
    description: "KYC, CKYC, account verification, and audit requirements need reliable infrastructure.",
  },
  {
    icon: fragmentIcon,
    title: "Fragmented integrations",
    description: "Multiple vendors, dashboards, formats, and operational dependencies.",
  },
  {
    icon: fileIcon,
    title: "Manual verification load",
    description: "Ops teams spend too much time checking documents, accounts, and customer data.",
  },
  {
    icon: eyeIcon,
    title: "Low visibility",
    description: "Hard to track KYC status, risk signals, handoffs, and audit trails across teams.",
  },
];
