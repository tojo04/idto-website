...
import trendingIcon from "../../../assets/solution_pages/banking_and_nbfcs/sections/product_stack/trending.svg";
...
const stackItems = [
  {
    icon: docIcon,
    title: "CKYC 2.0",
    description: "Centralized KYC search, download, create, and update workflows.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Pull user-consented Aadhaar and other issued documents.",
  },
  {
    icon: networkIcon,
    title: "Mobile Intelligence",
    description: "Improve customer intelligence with mobile-derived signals.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Verify customer and beneficiary accounts before payouts and disbursals.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Add biometric assurance for sensitive verification journeys.",
  },
  {
    icon: trendingIcon,
    title: "Verification Dashboard",
    description: "Track journeys, manage users, view reports, and support operations.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="banking-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
