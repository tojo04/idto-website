...
const useCases = [
  { icon: rocketIcon, title: "Fake account prevention" },
  { icon: repeatIcon, title: "Creator verification" },
  { icon: trendingIcon, title: "Community trust checks" },
  { icon: callIcon, title: "Payout verification" },
  { icon: tickIcon, title: "Account recovery workflows" },
  { icon: eyeIcon, title: "Risk-based onboarding" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to ship safer identity and risk flows for user-led platforms, creators, and communities.
          </p>
          <a
