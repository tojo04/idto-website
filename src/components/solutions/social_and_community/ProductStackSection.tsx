...
const stackItems = [
  {
    ...
    description: "Trigger light or heavy checks based on user behavior and risk.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Add document-backed verification when stronger checks are required.",
  },
  {
    icon: networkIcon,
    title: "Mobile Intelligence",
    description: "Check number quality, activity, reachability, and fraud signals.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Validate creator, user, or community payout accounts.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Verify high-risk users, creators, or payout-linked profiles.",
  },
  {
    icon: trendingIcon,
    title: "Alternate Data Enrichment",
    description: "Build better user context for trust, safety, and personalization.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="social-community-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
