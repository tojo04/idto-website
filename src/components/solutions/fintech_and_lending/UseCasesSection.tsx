...
const useCases = [
  { icon: rocketIcon, title: "Digital lending onboarding" },
  { icon: repeatIcon, title: "Repeat KYC using CKYC" },
  { icon: trendingIcon, title: "User risk enrichment" },
  { icon: callIcon, title: "Collections prioritization" },
  { icon: tickIcon, title: "Bank account verification" },
  { icon: eyeIcon, title: "Face match & liveness checks" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to ship full identity and risk flows &mdash; from first-time onboarding to last-mile collections.
          </p>
          <a
