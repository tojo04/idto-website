...
const stackItems = [
  {
    icon: docIcon,
    title: "CKYC 2.0",
    description: "Search, download, create, and update CKYC records through a single integration.",
  },
  {
    icon: dbIcon,
  ...
  },
  {
    ...
    description: "Understand number activity, reachability, telecom signals, and user context.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Verify account ownership and support safer payouts, disbursals, and changes.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Add biometric confidence for higher-risk onboarding journeys.",
  },
  {
    icon: trendingIcon,
    title: "Alternate Data Enrichment",
    description: "Use additional signals to improve risk, personalization, and decisioning.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="fintech-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
      <div className="max-w-[886px] mx-auto flex flex-col gap-10 items-center">
        ...
        >
          <h2 className="font-heading text-[20px] md:text-[42px] leading-[1.3] text-white">
            idto stack for fintech and lending
          </h2>
          <img
            src={linesAccent}
            alt=""
