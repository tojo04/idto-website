...
import trendingIcon from "../../../assets/solution_pages/insurance/product_stack/trending.svg";
...
const stackItems = [
  {
    icon: docIcon,
    title: "CKYC 2.0",
    description: "Search, download, create, and update CKYC records for policy onboarding.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Fetch Aadhaar and other user-consented documents with smoother UX.",
  },
  {
    icon: networkIcon,
    title: "Mobile Intelligence",
    description: "Understand number, reachability, customer activity, and engagement signals.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Verify policyholder and beneficiary bank accounts before payouts.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Add stronger identity confidence for higher-risk or remote journeys.",
  },
  {
    icon: trendingIcon,
    title: "Workflow Dashboard",
    description: "Track verification status, retries, and audit trails in one place.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="insurance-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
      <div className="max-w-[886px] mx-auto flex flex-col gap-10 items-center">
        ...
        >
          <h2 className="font-heading text-[20px] md:text-[42px] leading-[1.3] text-white">
            idto stack for insurance
          </h2>
          <img
            src={linesAccent}
            alt=""
            className="hidden sm:block absolute left-1/2 top-[55px] w-[260px] md:w-[370px] -translate-x-[18%]"
            loading="lazy"
            decoding="async"
          />
        </motion.div>
