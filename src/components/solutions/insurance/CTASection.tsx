...
import partner2 from "../../../assets/solution_pages/trust_partner/c085f2d06d11f7587b1b367e1dde3bbff9df2b5c.webp";
import partner3 from "../../../assets/solution_pages/trust_partner/c32420383094e102fb8b27a55fafa52b3a5abb73.webp";
        ...
        <div className="max-w-[1072px] mx-auto flex flex-col gap-[50px] items-center">
          <div className="flex flex-col gap-[45px] items-center justify-center w-full">
            <h2 className="max-w-[1069px] font-heading text-[20px] md:text-[42px] leading-[1.1] tracking-[-0.4px] lg:tracking-[-0.84px] text-black text-center">
              Build insurance verification workflows that are faster, safer, and easier to operate.
            </h2>
