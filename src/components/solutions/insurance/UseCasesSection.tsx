...
const useCases = [
  { icon: rocketIcon, title: "Policy onboarding" },
  { icon: repeatIcon, title: "CKYC-based customer verification" },
  { icon: trendingIcon, title: "Claims payout verification" },
  { icon: callIcon, title: "Refund account validation" },
  { icon: tickIcon, title: "Customer reachability scoring" },
  { icon: eyeIcon, title: "Personalized renewal and engagement workflows" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to ship full identity and risk flows from onboarding to claims, payouts, and renewals.
          </p>
          <a
