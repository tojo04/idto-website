...
const useCases = [
  { icon: rocketIcon, title: "Seller onboarding" },
  { icon: repeatIcon, title: "Vendor verification" },
  { icon: trendingIcon, title: "Buyer trust checks" },
  { icon: callIcon, title: "Service provider verification" },
  { icon: tickIcon, title: "Payout account validation" },
  { icon: eyeIcon, title: "Fraud and abuse prevention" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to ship full identity and trust flows &mdash; from first-time onboarding to safer marketplace payouts.
          </p>
          <a
