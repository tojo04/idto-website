...
const useCases = [
  { icon: rocketIcon, title: "Candidate Identity Verification" },
  { icon: repeatIcon, title: "Employee Document Verification" },
  { icon: trendingIcon, title: "Employee Bank Account Verification" },
  { icon: callIcon, title: "Address And Contactability Checks" },
  { icon: tickIcon, title: "Field Workforce Verification" },
  { icon: eyeIcon, title: "Faster Joining Workflows" },
];
      ...
      <div className="max-w-[1215px] mx-auto grid gap-10 lg:grid-cols-[481px_minmax(0,620px)] lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-4 max-w-[481px] mx-auto lg:mx-0 text-[13px] md:text-[16px] lg:text-[18px] leading-[1.5] tracking-[-0.36px] text-black/60">
            Mix and match the idto APIs to ship fast identity and risk flows from hiring to joining for modern workforces.
          </p>
          <a
