...
const stackItems = [
  {
    ...
    description: "Verify identity, education, employment, and candidate documents.",
  },
  {
    icon: dbIcon,
    title: "DigiLocker Verification Suite",
    description: "Fetch and verify government-backed candidate records.",
  },
  {
    icon: networkIcon,
    title: "Mobile Intelligence",
    description: "Check number quality, reachability, and candidate phone risk.",
  },
  {
    icon: verificationIcon,
    title: "IntelliBank Account Verification",
    description: "Verify salary or reimbursement bank accounts.",
  },
  {
    icon: faceMatchIcon,
    title: "Face Match + Liveness",
    description: "Confirm candidate presence and reduce impersonation risk.",
  },
  {
    icon: trendingIcon,
    title: "Dashboard & Audit Trail",
    description: "Track verification progress, status, history, and operations.",
  },
];
...
export default function ProductStackSection() {
  ...
  return (
    <section id="bgv-stack" className="solution-stack-section bg-[#1f44be] px-5 lg:px-12 min-[1440px]:px-[277px] py-16 lg:py-[117px] overflow-hidden">
      <div className="max-w-[886px] mx-auto flex flex-col gap-10 items-center">
        ...
        >
          <h2 className="font-heading text-[28px] md:text-[42px] leading-[1.3] text-white">
            idto stack for employment verification
          </h2>
          <img
            src={linesAccent}
            alt=""
