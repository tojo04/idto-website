  ...
  return (
    <div className="min-h-screen bg-gray-bg font-body text-dark">
      <SEOHead
        ...
        description="One API for KYC, KYB, and employee verification with AI-powered fraud prevention and global orchestration. DPDP-compliant. Book a demo with idto.ai."
        path="/"
      />
      <Header />
